...
if(isset($_GET["submit"]))
{
    ...
    $predictedY = shell_exec("python algo.py $val1 $val2 $val3 $val4 $val5 $val6 2>&1 ");
    ...
    if ($predictedY == 1) {
        ...
        echo ' <div class="alert alert-danger alert-dismissible fade show" role="alert"> <strong>Predicted Y: '.$predictedY.'  </strong>  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>  </div>';
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $message = $twilio->messages->create(
                    ...
                    array(
                        ...
                        A fire has been detected in your area. EVACUATE IMMEDIATELY.
                        BE SAFE... '
                    )
                );
        ...
        echo ' <div class="alert alert-success alert-dismissible fade show" role="alert"> <strong>Predicted Y: '.$predictedY.' </strong>  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>  </div>';
    }
}
?>
    ...
    <div class="container mt-5">
        ...
        <form action="one.php" method="get">
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    <label for="val2">MQ-4 (Methane Sensor)(ppm)</label>
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="val3">MQ-7 (CO Sensor)(ppm)</label>
                    <input type="text" class="form-control" id="val3" name="val3" required>
                </div>

                <div class="col">
                    <label for="val4">MQ-8 (Hydrogen Sensor)(ppm)</label>
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="val5">MQ-9 (CO Sensor)(ppm)</label>
                    <input type="text" class="form-control" id="val5" name="val5" required>
                </div>

                <div class="col">
                    <label for="val6">MQ-135 (Air Quality Sensor)(ppm)</label>
