...
<head>
  ...
  <style>
    * {
    ...
    body {
      background: #1B1B1D;
      /* background-image: url("Background Images/pexels-pixabay-236709.jpg"); */
  ...
  <header>
    <!-- <nav class="navbar">
      ...
      <ul class="menu-links">
        ...
        <li><a href="user_emergency_plan.php">Emergency Plan</a></li>
        <li><a href="user_training.php">Training Resources</a></li>
